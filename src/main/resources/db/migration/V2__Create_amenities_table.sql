...
insert into amenities (air_conditioning, bar_car, bicycles, compartmentless, dining_car, disabled_lift, disabled_seats,
                       electrical_outlets, sleeping_car, toilet, wifi)
