...
values (348, 'B9mnopuvz', 72, true, false, false, 2, true, true, true, 'Bmnopuvz-159A-a.gif',
        '159A_B9mnopuvz.png'),
       (349, 'B9mnopuz', 72, false, false, false, 2, true, true, true, 'Bmnopuz-159A-a.gif',
        '159A_B9mnopuz.png'),
       (350, 'B10bmnouz', 56, false, false, false, 2, true, true, true, 'B10bmnouz-XBNMg2-FPS-a.gif',
        '156A_B10bmnouz.png'),
       (351, 'WRmnouz', 0, false, true, false, null, true, true, true, 'WRmnouz-406A-30-a.gif',
        ''),
       (352, 'A9mnouz', 54, false, false, false, 1, true, true, true, 'A9mnouz-Z2AMg-FPS-a.gif',
        'Z_A9mnouz.png');
