...
#info {
  background: linear-gradient(0deg, rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.9)), url('../assets/backgrounds/departures-bg.jpg') no-repeat center center;
